...
> Note 1: The VirtualBox VM image is a 19GB file. The time it takes to download this file is determined by the internet connection speed. Therefore, we would like to kindly request that reviewers begin downloading this file prior to beginning the review process (check Step 1.2 of [Section-1](https://github.com/maldil/ICSE2023_PyEvolve_Artifacts#1-tool---pyevolve)). Furthermore, reviewers must have at least 40 GB of free space on their computer in order to load the file into VirtualBox. 
